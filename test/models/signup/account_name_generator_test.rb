...
class Signup::AccountNameGeneratorTest < ActiveSupport::TestCase
  ...
  test "generate" do
    ...
    assert_equal "Newart's #{JetKB::Brand::APP_NAME}", account_name, "The 1st account doesn't have 1st in the name"
    ...
    account_name = @generator.generate
    assert_equal "Newart's 2nd #{JetKB::Brand::APP_NAME}", account_name
    ...
    account_name = @generator.generate
    assert_equal "Newart's 3rd #{JetKB::Brand::APP_NAME}", account_name
    ...
    account_name = @generator.generate
    assert_equal "Newart's 4th #{JetKB::Brand::APP_NAME}", account_name
    ...
    account_name = @generator.generate
    assert_equal "Newart's 5th #{JetKB::Brand::APP_NAME}", account_name
  end

  test "generate continues from the previous highest index" do
    account = Account.create!(external_account_id: "12th", name: "Newart's 12th #{JetKB::Brand::APP_NAME}")
    Current.without_account do
    ...
    account_name = @generator.generate
    assert_equal "Newart's 13th #{JetKB::Brand::APP_NAME}", account_name
  end
end
