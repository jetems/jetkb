...
class ApplicationHelperTest < ActionView::TestCase
  ...
  test "page_title_tag on untenanted page" do
    ...
    assert_select parse(page_title_tag), "title", text: "#{JetKB::Brand::APP_NAME}"
  end
  ...
  test "page_title_tag on untenanted page with a page title" do
    ...
    assert_select parse(page_title_tag), "title", text: "Holodeck | #{JetKB::Brand::APP_NAME}"
  end
  ...
  test "page_title_tag on tenanted page when user has multiple accounts" do
    ...
    assert_select parse(page_title_tag), "title", text: "37signals | #{JetKB::Brand::APP_NAME}"
  end
  ...
  test "page_title_tag on tenanted page with a page title when user has multiple account" do
    ...
    assert_select parse(page_title_tag), "title", text: "Holodeck | 37signals | #{JetKB::Brand::APP_NAME}"
  end
end
