...
# Initial PostgreSQL schema for jetKB.
#
# Generated from db/schema.rb (the canonical MySQL/SQLite schema) with:
#   - charset / collation MySQL options stripped
#   - json columns -> jsonb (PG-native, faster, richer operators)
#   - FULLTEXT indexes removed (search_records_* full-text support is layered
#     on by a separate migration in Phase 2 using tsvector + GIN)
...
class CreateInitialSchema < ActiveRecord::Migration[8.2]
  def change
      ...
      create_table "events", id: :uuid, force: :cascade do |t|
        ...
        t.jsonb "particulars", default: -> { "'{}'::jsonb" }
        t.datetime "updated_at", null: false
      ...
      create_table "filters", id: :uuid, force: :cascade do |t|
        ...
        t.datetime "created_at", null: false
        t.uuid "creator_id", null: false
        t.jsonb "fields", default: -> { "'{}'::jsonb" }, null: false
